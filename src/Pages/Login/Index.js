  ...
  return (
    <View className="flex-1 justify-center items-center gap-y-2 bg-blue-950">
      <View className="justify-center">
        <Text className="font-bold text-4xl text-white text-center pb-14">
          MyCompany.
        </Text>
        <Text className="font-bold text-x text-white text-center pb-3">
          Login
        </Text>
        ...
        />
        {errors.Email && (
          <Text className="text-white">Digite um E-mail valido</Text>
        )}
